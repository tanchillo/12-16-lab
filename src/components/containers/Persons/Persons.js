...
class Persons extends Component {
    ...
    async componentDidMount() {
        try {
            const response  = await axios.get('https://pautov-scripts.firebaseio.com/persons.json');
    ...
    render() {
        return (
            //Тут будут лежать все сотрудники, взятые из базы
                ...
                <div className="persons-list">
                    <div className={'card'}>
                        <div className={'card-header'}>
                            Persons List
                            <NavLink to={'/add'}><Button variant={'primary'}><i className="fas fa-plus"/></Button></NavLink>
                        </div>
                        <div className={'card-body'}>
